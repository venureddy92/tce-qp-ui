...
// import { McqSingleSelectLayoutComponent } from 'libs/quiz-templates/src/lib/mcq-single-select/mcq-single-select.module';
...
export class AppComponent {
  ...
  defaultJson ={"title":"","question_type":"Multiple Choice","options":["Multiple Choice","Match the Column","Open Ended","Fill in the Blank","Hotspot"]}
  isShown = false;
  questionPaperJson ={id:"",title:"","marks":10,"meta":[
      {"sections":[
