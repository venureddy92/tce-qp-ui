...
@Component({
  selector: 'app-mcq-matrix-labels-layout',
  templateUrl: './mcq-matrix-labels-layout.component.html',
  styleUrls: ['./mcq-matrix-labels-layout.component.css']
})
export class McqMatrixLabelsLayoutComponent implements OnInit {
  ...
  getSelectedAns(eventData) {
    ...
    if (this.inputType == 'checkbox') {
      ...
      // console.log('dcdsfs ', this.selectedAnswers[0]);
      this.selectedAnswers[eventData.i] = [event.target.value];
    }
