...
function createRootStorybookDir(tree, js, workspaceStorybookVersion) {
...
function readCurrentWorkspaceStorybookVersion(tree) {
    ...
    if (semver_1.gte(version_utils_1.checkAndCleanWithSemver('@storybook/core', workspaceStorybookVersion), '6.0.0')) {
