...
function updateModuleName(tree, { projectName, destination }) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const moduleName = {
            from: devkit_1.names(projectName).className,
            to: devkit_1.names(newProjectName).className,
        };
        ...
        // update index file
        const indexFile = path_1.join(project.sourceRoot, 'index.ts');
        ...
        for (const [name, definition] of devkit_1.getProjects(tree)) {
            devkit_1.visitNotIgnoredFiles(tree, definition.root, (file) => {
