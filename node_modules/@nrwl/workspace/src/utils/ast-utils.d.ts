...
import type { NxJsonConfiguration, NxJsonProjectConfiguration, ProjectGraph } from '@nrwl/devkit';
...
export declare function addProjectToNxJsonInTree(projectName: string, options: NxJsonProjectConfiguration): Rule;
