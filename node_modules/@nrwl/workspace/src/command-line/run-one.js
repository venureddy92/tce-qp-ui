...
function runOne(opts) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        perf_hooks_1.performance.measure('code-loading-and-file-hashing', 'init-local', 'command-execution-begins');
...
function getProjects(projectGraph, includeDeps, project, target) {
    ...
    if (includeDeps) {
        ...
        const deps = s.onlyWorkspaceProjects(s.withDeps(projectGraph, projects)).nodes;
