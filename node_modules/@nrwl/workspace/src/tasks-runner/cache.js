...
class Cache {
    ...
    isAnyOutputMissing(cachedResult, outputs) {
        return outputs.some((output) => {
            ...
            const haveDifferentAmountOfFiles = fs_1.existsSync(cacheOutputPath) &&
                fs_1.existsSync(rootOutputPath) &&
                fs_extra_1.readdirSync(cacheOutputPath).length !==
                    fs_extra_1.readdirSync(rootOutputPath).length;
            return ((fs_1.existsSync(cacheOutputPath) && !fs_1.existsSync(rootOutputPath)) ||
