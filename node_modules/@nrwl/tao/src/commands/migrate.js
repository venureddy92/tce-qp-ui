...
function runNxMigration(root, packageName, name) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        generate_1.flushChanges(root, changes);
    });
}
function removeNxDepsIfCaseItsFormatChanged(root) {
    fs_extra_1.removeSync(path_1.join(root, 'node_modules', '.cache', 'nx', 'nxdeps.json'));
}
