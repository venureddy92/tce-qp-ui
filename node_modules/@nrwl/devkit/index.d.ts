...
export type { WorkspaceJsonConfiguration, TargetDependencyConfig, TargetConfiguration, ProjectConfiguration, ProjectType, Generator, GeneratorCallback, Executor, ExecutorContext, Workspace, } from '@nrwl/tao/src/shared/workspace';
...
export type { ProjectFileMap, FileData, ProjectGraph, ProjectGraphDependency, ProjectGraphNode, NxPlugin, ProjectGraphProcessorContext, } from './src/project-graph/interfaces';
